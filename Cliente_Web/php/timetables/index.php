...
function tablatimetable($condicion,$conn){
    parse_str($condicion, $cons);
    $start = True;
    $query = "SELECT * FROM timetables WHERE id_student in (SELECT id_student FROM students WHERE name LIKE '%" . $_SESSION['nombreuser'] . "%')";
    $date = new DateTime();
