...
$start = False;
$query = "SELECT day, hour, subject, room FROM timetables WHERE id_student in (SELECT id_student FROM students WHERE name LIKE '%" . $cons['nombreuser'] . "%')";;
$date = new DateTime();
